...
def register():
    conn=mysql.connector.connect(host='127.0.0.1',port='3306',user='root',password='hesoyam17502',database='hi')
...
btn1  = Button(window ,text="Submit",command=register,width=15, bg= 'green',fg='yellow',pady=10,).grid(row=5,column=1)
